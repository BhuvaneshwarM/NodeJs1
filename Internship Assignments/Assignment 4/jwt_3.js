...
var token=jwt.sign({payload:"this is the payload"},"\n secretkey",{ algorithm: 'HS256'});//  Algorithm here is HMAC SHA256
...
jwt.verify(tokenReceived,"\n secretkey",{ algorithm: ['HS256']},function(err,data){ // This feature of JWT is to verify the token received and hence ensuring if the payload should be accepted 
    if(!err){
